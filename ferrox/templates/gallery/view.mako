...
<div class="basic-box">
    <div class="submission-content submission-content-${c.submission.type}">
        ...
        ${h.image_tag(h.url_for(controller='gallery', action='derived_file', filename=c.submission.get_derived_key('fullview'), id=None), c.submission.title)}
        ...
        ${h.HTML.a('Text Submission', href=h.url_for(controller='gallery', action='file', filename=c.submission.main_storage.storage_key))}, Text submission
        <pre>
        TODO?
        </pre>
        % else:
