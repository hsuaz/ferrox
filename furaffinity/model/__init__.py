...
from furaffinity.model.db.note import *
...
user_relationship_mapper = mapper(UserRelationship, user_relationship_table, properties=dict(
    user = relation(User, primaryjoin=user_relationship_table.c.from_user_id==User.id, backref='relationships'),
    target = relation(User, primaryjoin=user_relationship_table.c.to_user_id==User.id),
    ),
)
