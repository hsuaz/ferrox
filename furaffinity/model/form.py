...
class SubmitForm(formencode.Schema):
    ...
    description = validators.NotEmpty(not_empty=True)
    commit = validators.PlainText(not_empty=False)
...
class DeleteForm(formencode.Schema):
    confirm = validators.PlainText(not_empty=False, if_missing=None)
    cancel = validators.PlainText(not_empty=False, if_missing=None)
